...
public class IssueApiTest {
    ...
    public void issueSearchIssuesTest() throws ApiException {
        ...
        Integer page = null;
        Integer limit = null;
        List<Issue> response = api.issueSearchIssues(state, labels, milestones, q, priorityRepoId, type, since, before, assigned, created, mentioned, reviewRequested, page, limit);
