...
public class IssueApiTest {
    ...
    public void issueSearchIssuesTest() throws ApiException {
        ...
        String type = null;
        Integer page = null;
        List<Issue> response = api.issueSearchIssues(state, labels, q, priorityRepoId, type, page);
    ...
    public void issueTrackedTimesTest() throws ApiException {
        ...
        Integer page = null;
        Integer limit = null;
        List<TrackedTime> response = api.issueTrackedTimes(owner, repo, index, since, before, page, limit);
