...
public class Repository {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMergeCommits, allowRebase, allowRebaseExplicit, allowSquashMerge, archived, avatarUrl, cloneUrl, createdAt, defaultBranch, description, empty, externalTracker, externalWiki, fork, forksCount, fullName, hasIssues, hasProjects, hasPullRequests, hasWiki, htmlUrl, id, ignoreWhitespaceConflicts, internal, internalTracker, mirror, mirrorInterval, name, openIssuesCount, openPrCounter, originalUrl, owner, parent, permissions, _private, releaseCounter, size, sshUrl, starsCount, template, updatedAt, watchersCount, website);
  }
