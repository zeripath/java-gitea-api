...
public class MigrateRepoForm {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authPassword, authToken, authUsername, cloneAddr, description, issues, labels, milestones, mirror, mirrorInterval, _private, pullRequests, releases, repoName, service, uid, wiki);
  }
