...
public class EditRepoOption {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowManualMerge, allowMergeCommits, allowRebase, allowRebaseExplicit, allowSquashMerge, archived, autodetectManualMerge, defaultBranch, description, externalTracker, externalWiki, hasIssues, hasProjects, hasPullRequests, hasWiki, ignoreWhitespaceConflicts, internalTracker, mirrorInterval, name, _private, template, website);
  }
