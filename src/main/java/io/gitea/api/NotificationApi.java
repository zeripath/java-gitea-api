...
public class NotificationApi {
    ...
    private com.squareup.okhttp.Call notifyGetListValidateBeforeCall(String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = notifyGetListCall(all, statusTypes, since, before, page, limit, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<NotificationThread> notifyGetList(String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit) throws ApiException {
        ApiResponse<List<NotificationThread>> resp = notifyGetListWithHttpInfo(all, statusTypes, since, before, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<NotificationThread>> notifyGetListWithHttpInfo(String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = notifyGetListValidateBeforeCall(all, statusTypes, since, before, page, limit, null, null);
     ...
     */
    public com.squareup.okhttp.Call notifyGetListAsync(String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit, final ApiCallback<List<NotificationThread>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = notifyGetListValidateBeforeCall(all, statusTypes, since, before, page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<NotificationThread>>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call notifyGetRepoListCall(String owner, String repo, String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call notifyGetRepoListValidateBeforeCall(String owner, String repo, String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = notifyGetRepoListCall(owner, repo, all, statusTypes, since, before, page, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<NotificationThread> notifyGetRepoList(String owner, String repo, String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit) throws ApiException {
        ApiResponse<List<NotificationThread>> resp = notifyGetRepoListWithHttpInfo(owner, repo, all, statusTypes, since, before, page, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<NotificationThread>> notifyGetRepoListWithHttpInfo(String owner, String repo, String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = notifyGetRepoListValidateBeforeCall(owner, repo, all, statusTypes, since, before, page, limit, null, null);
        Type localVarReturnType = new TypeToken<List<NotificationThread>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call notifyGetRepoListAsync(String owner, String repo, String all, List<String> statusTypes, OffsetDateTime since, OffsetDateTime before, Integer page, Integer limit, final ApiCallback<List<NotificationThread>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = notifyGetRepoListValidateBeforeCall(owner, repo, all, statusTypes, since, before, page, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<NotificationThread>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
